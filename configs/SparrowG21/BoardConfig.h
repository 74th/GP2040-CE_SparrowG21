...
#define GPIO_PIN_16 GpioAction::BUTTON_PRESS_B2		 // B2     | B      | A       | Circle   | 3      | K2     |
#define GPIO_PIN_20 GpioAction::BUTTON_PRESS_R2		 // R2     | RT     | ZR      | R2       | 8      | K3     |
#define GPIO_PIN_22 GpioAction::BUTTON_PRESS_L2		 // L2     | LT     | ZL      | L2       | 7      | K4     |
